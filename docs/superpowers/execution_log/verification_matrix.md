...
| **T12.5** | ✅ c1_descriptors.py + 8 TDD pass | ✅ smoke 5 (estrutura) + smoke 20 (critério) | ✅ redução **78.6%** em C1 (28→6) acima do threshold 70% | ✅ 0 parse failures, custo $0.015 | (próximo) | **DONE** (pendente commit) |
